...
// on `typeof window` so that nine coexisting pages stay visible for the gate.
//
...
// gate's shim deliberately leaves all nine pages visible so that nine
...
goto("ch03");
chk("a chapter says which one it is", ids["bookbar-where"].textContent, "Chapter 3 of 7");
